 ...
 * @param zip_info Pointer to the zip_info struct
 ...
 * @param zip_to_destroy The zip_info struct to print it's information
 */
void zip_info_destroy(zip_info_t* zip_to_destroy);

/**
 * @brief Frees memory allocated for a zip_info struct
 * @param zip_to_print Pointer to the zip_info to print
 */
